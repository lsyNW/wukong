...
(defsystem "roborts_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "DecisionCtrl" :depends-on ("_package_DecisionCtrl"))
    (:file "_package_DecisionCtrl" :depends-on ("_package"))
    (:file "DecisionInfo" :depends-on ("_package_DecisionInfo"))
    (:file "_package_DecisionInfo" :depends-on ("_package"))
    ...
    (:file "GimbalQuat" :depends-on ("_package_GimbalQuat"))
    (:file "_package_GimbalQuat" :depends-on ("_package"))
    ...
    (:file "KalmanPlot" :depends-on ("_package_KalmanPlot"))
    (:file "_package_KalmanPlot" :depends-on ("_package"))
    ...
    (:file "banbuff" :depends-on ("_package_banbuff"))
    (:file "_package_banbuff" :depends-on ("_package"))
    (:file "errgoal" :depends-on ("_package_errgoal"))
    (:file "_package_errgoal" :depends-on ("_package"))
    (:file "glass" :depends-on ("_package_glass"))
    (:file "_package_glass" :depends-on ("_package"))
    (:file "ismaster" :depends-on ("_package_ismaster"))
    (:file "_package_ismaster" :depends-on ("_package"))
  ))