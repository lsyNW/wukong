...
if(NOT "/home/wukong1/N1/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sentry_to_car' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wukong1/N1/src/RoboRTS/sentry_to_car/${idir}'.  ${_report}")
    endif()
